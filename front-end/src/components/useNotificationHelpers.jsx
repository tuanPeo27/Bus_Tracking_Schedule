...
export function useNotificationHelpers() {
  ...
  const systemNotifications = {
    ...
    logout: () =>
      showInfo("Đã đăng xuất", "Cảm ơn bạn đã sử dụng SmartBus 1.0.", 3000),
    ...
    maintenanceReminder: (vehicle, dueDate) =>
      showWarning(
        "Nhắc nhở bảo trì",
